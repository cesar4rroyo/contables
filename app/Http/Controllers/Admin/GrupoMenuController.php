...
{
    protected $folderview      = 'admin.grupomenu';
    protected $tituloAdmin     = 'Grupo de Menú';
    protected $tituloRegistrar = 'Registrar Grupo de Menú';
    protected $tituloModificar = 'Modificar Grupo de Menú';
    protected $tituloEliminar  = 'Eliminar Grupo de Menú';
    ...
    public function buscar(Request $request)
    {
        ...
        $resultado        = GrupoMenu::where('descripcion', 'LIKE', '%'.strtoupper($nombre).'%')->orderBy('orden', 'ASC');
        $lista            = $resultado->get();
        $cabecera         = array();
    ...
    public function store(Request $request)
    {
        ...
        $error = DB::transaction(function() use($request){
            $grupomenu = GrupoMenu::create([
                ...
                'orden'=>Libreria::getParam($request->input('orden'), 1),
            ]);
        });
