...
<div class="container" id="container">
    <div class="row justify-content-center">
      <div class="col-lg-8 col-md-8 col-offset-2">
            <div class="card">
                <div class="card-header">Reporte Venta</div>

                <div class="card-body">
                    <div class="row">
                        {!! Form::open(['route' => 'reporteventa.pdfVenta', 'method' => 'POST' ,'onsubmit' => 'return false;', 'class' => 'w-100  mt-3', 'role' => 'form', 'autocomplete' => 'off', 'id' => 'formBusqueda'.$entidad]) !!}
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6  form-group">
                                ...
                                {!! Form::select('cliente', $clientes , '' ,array('class' => 'form-control  input-xs', 'id' => 'cliente', 'required'=>'true')) !!}
                            </div>
                            <div class="col-lg-6 col-md-6  form-group">
...
<script type="text/javascript">
   $(document).ready(function ()  {
        ...
        function imprimirpdf(){
            window.open("reporteventa/pdfVenta?fechainicio="+$("#fechainicio").val()+"&fechafin="+$("#fechafin").val()+"&cliente="+$("#cliente").val()+"&estado="+$("#estado").val(),"_blank");
        }
</script>