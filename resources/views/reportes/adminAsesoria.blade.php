...
<div class="container" id="container">
    <div class="row justify-content-center">
      <div class="col-lg-8 col-md-8 col-offset-2">
            <div class="card">
                <div class="card-header">Reporte Asesoria</div>

                <div class="card-body">
                    <div class="row">
                        {!! Form::open(['route' => 'reporteasesoria.pdfAsesoria', 'method' => 'POST' ,'onsubmit' => 'return false;', 'class' => 'w-100  mt-3', 'role' => 'form', 'autocomplete' => 'off', 'id' => 'formBusqueda'.$entidad]) !!}
...
<script type="text/javascript">
   $(document).ready(function ()  {
        ...
        function imprimirpdf(){
            window.open("reporteasesoria/pdfAsesoria?fechainicio="+$("#fechainicio").val()+"&fechafin="+$("#fechafin").val()+"&cliente="+$("#cliente").val(),"_blank");
        }
</script>