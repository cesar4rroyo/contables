...
<body>
    ...
    <table>
        <thead>
        <tr>
            <th colspan="8" style="text-align: center"><b>REPORTE COMPRAS DESDE {{ date_format(date_create($fecinicio),  'd/m/Y') }} HASTA {{ date_format(date_create($fecfin),  'd/m/Y') }} - LAMBAYEQUE TECHNOLOGIES </b></th>
        </tr>
        <tr>
            <th><b>NUMERO</b></th>
            <th><b>ESTADO</b></th>
            <th><b>FECHA SOLICITUD</b></th>
            <th><b>FECHA ESPERADA</b></th>
        ...
        @foreach($lista1 as $key => $value)
            <tr>
                ...
                <td class="padding-left">{{ $value->fechaesperada }}</td>
